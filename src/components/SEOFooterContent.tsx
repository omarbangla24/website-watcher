const SEOFooterContent = () => {
  return (
    <section className="container mx-auto px-4 py-12 border-t border-border" aria-label="About website status checker" itemScope itemType="https://schema.org/FAQPage">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
          ...
          <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
            <ul className="text-sm text-muted-foreground leading-relaxed list-disc list-inside space-y-1" itemProp="text">
